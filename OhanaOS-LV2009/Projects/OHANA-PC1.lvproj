...
<Project Type="Project" LVVersion="9008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Server" Type="Folder">
			...
			<Item Name="Server.ini" Type="Document" URL="../../Server/Server.ini"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="NicmosGetData.vi" Type="VI" URL="../../Instruments/Nicmos/Clients/NicmosGetData.vi"/>
			<Item Name="NICMOS.DATA.ctl" Type="VI" URL="../../Instruments/Nicmos/Controls/NICMOS.DATA.ctl"/>
			<Item Name="NicmosGetReadout.vi" Type="VI" URL="../../Instruments/Nicmos/Clients/NicmosGetReadout.vi"/>
			<Item Name="GaussianFit2D.vi" Type="VI" URL="../../Instruments/Math/GaussianFit2D.vi"/>
			<Item Name="GaussianFit1D.vi" Type="VI" URL="../../Instruments/Math/GaussianFit1D.vi"/>
			<Item Name="DetectFrangeAmplitude.vi" Type="VI" URL="../../../Ohana_Development/Instruments/OHANA IKI/Codes Yue/sous-vis/DetectFrangeAmplitude.vi"/>
			<Item Name="DetectFrangesFrequence.vi" Type="VI" URL="../../../Ohana_Development/Instruments/OHANA IKI/Codes Yue/sous-vis/DetectFrangesFrequence.vi"/>
			<Item Name="Remove slope.vi" Type="VI" URL="../../Procedures/Nicmos data processing functions/Remove slope.vi"/>
			<Item Name="BandPassFilter.vi" Type="VI" URL="../../Instruments/Math/BandPassFilter.vi"/>
			<Item Name="Chanotch.vi" Type="VI" URL="../../Instruments/Math/Chanotch.vi"/>
			<Item Name="DelayGenerator.ctl" Type="VI" URL="../../Instruments/DelayGenerator/Controls/DelayGenerator.ctl"/>
			<Item Name="AerotechGetActual.vi" Type="VI" URL="../../Instruments/Aerotech/Clients/AerotechGetActual.vi"/>
			<Item Name="Constantes.vi" Type="VI" URL="../../Instruments/DelayGenerator/Constantes.vi"/>
			<Item Name="BalancedDifference.vi" Type="VI" URL="../../Procedures/Nicmos data processing functions/BalancedDifference.vi"/>
			<Item Name="ApplatitExtrema.vi" Type="VI" URL="../../../Ohana_Development/Instruments/OHANA IKI/Codes Yue/sous-vis/ApplatitExtrema.vi"/>
			<Item Name="MotorSelect.vi" Type="VI" URL="../../Instruments/Motor/Clients/MotorSelect.vi"/>
			<Item Name="MotorCommand.ctl" Type="VI" URL="../../Instruments/Motor/Controls/MotorCommand.ctl"/>
			<Item Name="MotorCommandBasic.ctl" Type="VI" URL="../../Instruments/Motor/Controls/MotorCommandBasic.ctl"/>
			<Item Name="MotorPosition.vi" Type="VI" URL="../../Instruments/Motor/Clients/MotorPosition.vi"/>
			<Item Name="MotorInfo.vi" Type="VI" URL="../../Instruments/Motor/Clients/MotorInfo.vi"/>
			<Item Name="MotorStatus.ctl" Type="VI" URL="../../Instruments/Motor/Controls/MotorStatus.ctl"/>
			<Item Name="MotorOff.vi" Type="VI" URL="../../Instruments/Motor/Clients/MotorOff.vi"/>
			<Item Name="StopUserEvent.ctl" Type="VI" URL="../../Procedures/Ressources/StopUserEvent.ctl"/>
			<Item Name="Stop.ctl" Type="VI" URL="../../Procedures/Ressources/Stop.ctl"/>
			<Item Name="MotorWaitIdle.vi" Type="VI" URL="../../Instruments/Motor/Clients/MotorWaitIdle.vi"/>
			<Item Name="MotorMove.vi" Type="VI" URL="../../Instruments/Motor/Clients/MotorMove.vi"/>
			<Item Name="SendStopUserEvent.vi" Type="VI" URL="../../Procedures/Ressources/SendStopUserEvent.vi"/>
			<Item Name="Motor-HandPaddle.vi" Type="VI" URL="../../Procedures/Motor-HandPaddle.vi"/>
			<Item Name="ActuatorMotor.vi" Type="VI" URL="../../Instruments/RasterScan/Sensors/ActuatorMotor.vi"/>
			<Item Name="SensorNicmos.vi" Type="VI" URL="../../Instruments/RasterScan/Sensors/SensorNicmos.vi"/>
			<Item Name="NICMOS.FILTER.ctl" Type="VI" URL="../../Instruments/Nicmos/Controls/NICMOS.FILTER.ctl"/>
			<Item Name="NICMOS.TEMPERATURE.ctl" Type="VI" URL="../../Instruments/Nicmos/Controls/NICMOS.TEMPERATURE.ctl"/>
			...
			<Item Name="NicmosGetTemperature.vi" Type="VI" URL="../../Instruments/Nicmos/Clients/NicmosGetTemperature.vi"/>
			<Item Name="IkiOpen.vi" Type="VI" URL="../../Instruments/Iki/IkiOpen.vi"/>
